...
export async function POST(req: NextRequest) {
  try {
    // --- Original OpenAI draft generation code (commented out for testing) ---
    ...
    // --- Hardcoded draft for testing ---
    const draftEmail = `
      <html>
        <body>
          <p>Dear Client,</p>
          <p>This is a <b>hardcoded</b> preview email draft for testing purposes.</p>
